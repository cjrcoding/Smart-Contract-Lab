...
/* package game-app-0.1.0.0 */
#ifndef VERSION_game_app
#define VERSION_game_app "0.1.0.0"
#endif /* VERSION_game_app */
#ifndef MIN_VERSION_game_app
#define MIN_VERSION_game_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_game_app */
...
#define CURRENT_COMPONENT_ID "game-app-0.1.0.0-inplace-game-app"
