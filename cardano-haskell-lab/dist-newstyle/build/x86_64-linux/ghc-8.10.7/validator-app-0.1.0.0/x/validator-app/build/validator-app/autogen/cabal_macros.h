...
/* package validator-app-0.1.0.0 */
#ifndef VERSION_validator_app
#define VERSION_validator_app "0.1.0.0"
#endif /* VERSION_validator_app */
#ifndef MIN_VERSION_validator_app
#define MIN_VERSION_validator_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_validator_app */
...
#define CURRENT_COMPONENT_ID "validator-app-0.1.0.0-inplace-validator-app"
